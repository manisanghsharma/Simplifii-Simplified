...
const AttendanceUI = () => {
	...
	// Animation effect for attendance percentage
	useEffect(() => {
		const animationDuration = 200; // 1.5 seconds
	...
	return (
		<div className='h-[100dvh] bg-gray-50 relative flex flex-col'>
			{/* Sliding Menu */}
			<div
			...
			>
				<div className='p-4'>
					...
					<ul className='space-y-2'>
						<li>
							<button className='w-full text-left px-4 py-2 hover:bg-gray-100 rounded-md flex items-center gap-2'>
					...
					<div className='bg-white rounded-lg shadow-lg p-6 space-y-6'>
						<div className='text-center'>
							...
							<div className='relative pt-1'>
								...
								<p className='text-3xl font-bold text-blue-600 transition-all duration-1000'>
									{animatedAttendance}%
								</p>
							</div>
						</div>
						...
						<div className='pt-4 border-t flex justify-between items-center'>
							...
							<button
								...
								className='p-2 hover:bg-gray-100 rounded-md text-gray-600 hover:text-gray-700 transition-colors'
							>
								<RefreshCw size={20} />
							</button>
						</div>
